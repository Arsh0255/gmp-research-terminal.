...
#  POLICYPULSE OMNISCIENT RESEARCH TERMINAL (vFINAL - STABLE)
...
tabs = st.tabs(["Phase 1: Macro", "Phase 2: Events", "Phase 3: NLP", "Phase 4: Diagnostics", "Phase 5: Scenario Sim", "3D Lab"])
